        ...
        <div className="footer-service-areas">
          <div className="container">
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '0.5rem', marginBottom: '1.5rem' }}>
              {regions.map((r) => (
                <Link
                  key={r.slug}
                  href={`/regions/${r.slug}`}
                  style={{ background: 'rgba(201,168,76,0.15)', color: '#D4A853', padding: '0.375rem 0.875rem', borderRadius: '6px', fontSize: '0.8125rem', fontWeight: 600, border: '1px solid rgba(201,168,76,0.25)' }}
                >
                  {r.name}
                </Link>
              ))}
            ...
            <div style={{ textAlign: 'center', marginBottom: '1rem' }}>
              <Link href="/massachusetts" style={{ color: '#D4A853', fontSize: '0.8125rem', fontWeight: 600 }}>
