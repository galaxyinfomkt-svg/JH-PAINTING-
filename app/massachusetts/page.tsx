...
import { cities, normalizeCitySlug, CITY_COUNT } from '@/app/data/cities'
...
export const metadata: Metadata = generatePageMetadata({
  ...
  title: `Painters Near Me MA | ${CITY_COUNT} Cities | JH Painting`,
  ...
  description: `Painters near you across ${CITY_COUNT} MA cities: Boston, Worcester, Cambridge, Newton, Framingham. 5.0★ from 40+ reviews. Free quote: (508) 690-8886`,
  path: '/massachusetts',
...
export default function MassachusettsPage() {
  ...
  return (
    <>
      ...
      />
    <main id="main-content" className="cities-index-page">
      {/* Hero Section */}
