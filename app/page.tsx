  ...
  return (
    <>
      ...
      <main id="main-content">
          ...
          <div className="hero-content container">
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 500px), 1fr))', gap: '3rem', alignItems: 'center' }}>
              <div className="hero-text">
                ...
                <p style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', padding: '0.5rem 1.25rem', background: 'rgba(212,168,83,0.9)', borderRadius: '100px', color: '#000', fontSize: '0.8125rem', fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: '1.25rem' }}>
                  Serving 117+ Massachusetts Cities
                </p>

                {/* 5-Star rating badge */}
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1rem' }}>
                  <div style={{ display: 'flex', gap: '2px', color: '#D4A853' }}>
                    <StarIcon size={18} fill="#D4A853" />
                    <StarIcon size={18} fill="#D4A853" />
                    <StarIcon size={18} fill="#D4A853" />
                    <StarIcon size={18} fill="#D4A853" />
                    <StarIcon size={18} fill="#D4A853" />
                ...
                <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', marginBottom: '1.5rem' }}>
                  <a href="tel:+15086908886" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.75rem', padding: '1rem 2rem', background: 'linear-gradient(135deg, #D4A853 0%, #B8923F 100%)', color: '#000', borderRadius: '8px', fontSize: '1.125rem', fontWeight: 700, textDecoration: 'none', boxShadow: '0 10px 40px rgba(212,168,83,0.35)', transition: 'all 0.3s ease', border: 'none' }}>
                    <PhoneIcon />
                    Call (508) 690-8886
                  </a>
              ...
              <div className="about-content">
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1rem', marginTop: '2rem' }}>
                  {[
                    ...
                    <div key={i} style={{ textAlign: 'center', padding: '1.25rem 0.75rem', background: 'rgba(212,168,83,0.1)', border: '1px solid rgba(212,168,83,0.2)', borderRadius: '12px' }}>
                      <div style={{ fontSize: '1.75rem', fontWeight: 800, color: '#D4A853', lineHeight: 1.2 }}>{stat.value}</div>
              ...
              <div className="contact-info">
                <div className="contact-info-card">
                  ...
                  <div className="contact-item">
                    <div className="contact-item-icon" style={{ background: 'rgba(212,168,83,0.1)', color: '#D4A853' }}>
                      <PhoneIcon />
                    </div>
                  ...
                  <div style={{ display: 'flex', gap: '0.75rem', marginTop: '1.5rem', paddingTop: '1.5rem', borderTop: '1px solid var(--jh-line)' }}>
                    <a href="https://www.facebook.com/profile.php?id=61564489391475" target="_blank" rel="noopener noreferrer" style={{ width: '40px', height: '40px', borderRadius: '50%', background: '#000', color: '#D4A853', display: 'flex', alignItems: 'center', justifyContent: 'center' }} aria-label="Facebook">
                      <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                    </a>
                    <a href="https://www.instagram.com/jhpaintingservices_/" target="_blank" rel="noopener noreferrer" style={{ width: '40px', height: '40px', borderRadius: '50%', background: '#000', color: '#D4A853', display: 'flex', alignItems: 'center', justifyContent: 'center' }} aria-label="Instagram">
                    ...
                    <a href="https://www.youtube.com/@JHPaintingServices-br9wh" target="_blank" rel="noopener noreferrer" style={{ width: '40px', height: '40px', borderRadius: '50%', background: '#000', color: '#D4A853', display: 'flex', alignItems: 'center', justifyContent: 'center' }} aria-label="YouTube">
                ...
                <div className="map-container">
                  <a href="https://g.co/kgs/hc9Rfmv" target="_blank" rel="noopener noreferrer" className="static-map-link" aria-label="View JH Painting Services on Google Maps">
                    <div className="static-map-placeholder" style={{ border: '2px solid #D4A853' }}>
                      <MapPinIcon />
        ...
        <section className="cta-section cta-section-enhanced" style={{ background: 'linear-gradient(135deg, #D4A853 0%, #B8923F 100%)' }}>
          <div className="container">
            <div className="cta-content" style={{ color: '#000' }}>
              <h2 style={{ color: '#000' }}>Ready to Transform Your Home?</h2>
              <p style={{ color: 'rgba(0,0,0,0.8)' }}>Licensed & $2M insured. 5-star rated. Same-day response on all estimates.</p>
              <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', justifyContent: 'center' }}>
                <a href="tel:+15086908886" className="btn btn-lg" style={{ background: '#000', color: '#D4A853', boxShadow: '0 4px 20px rgba(0,0,0,0.3)' }}>
                  <PhoneIcon />
                  Call (508) 690-8886
                </a>
                <a href="#quote-form" className="btn btn-lg" style={{ background: 'transparent', color: '#000', border: '2px solid #000' }}>
                  Get Free Estimate
                  <ChevronRightIcon size={18} />
                </a>
              </div>
