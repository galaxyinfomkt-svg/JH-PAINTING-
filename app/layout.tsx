      ...
      <head>
        ...
        <style dangerouslySetInnerHTML={{ __html: `
          ...
          *,*::before,*::after{box-sizing:border-box}
          ...
          .skip-link{position:absolute;top:-100%;left:50%;transform:translateX(-50%);background:#0a0e27;color:#CC0000;padding:.75rem 1.5rem;z-index:100000;border-radius:0 0 8px 8px;font-weight:600;font-size:.875rem;text-decoration:none;transition:top .2s ease}.skip-link:focus{top:0}
