  ...
  "@graph": [
    ...
    },
    {
      ...
      "hasOfferCatalog": {
        ...
        "itemListElement": [
          { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Exterior House Painting", "url": "https://jhpaintingservices.com/services/exterior-painting" }, "description": `Complete exterior house painting with power washing, scraping, caulking, priming, and two coats of premium weather-resistant paint. 5-year warranty. Serving ${CITY_COUNT} cities in Massachusetts.` },
