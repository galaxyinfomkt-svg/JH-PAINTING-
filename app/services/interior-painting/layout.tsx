...
export const metadata: Metadata = {
  title: 'Interior Painting Services in Massachusetts | JH Painting',
  description: 'Professional interior painting in Massachusetts. Wall painting, trim work, color consultation. Premium paints, licensed contractors. Free estimates.',
