...
export const exteriorExpansion: ServiceVariantPack = {
  ...
  introTemplates: [
    ...
    'Curb appeal in {cityName} doesn\'t just sell homes - it tells your neighbors how you maintain your investment. Our exterior painting in {neighborhoodsList} delivers two-tone schemes, crisp trim lines, and color-coordinated accents that lift the whole street.',
...
export const cabinetExpansion: ServiceVariantPack = {
  painPointVariants: [
    ...
    [
      ...
      { title: 'Two-Tone Kitchen Trending?', desc: 'You want upper cabinets one color, lower cabinets another, island a third - but execution is tricky.', solution: 'Multi-color cabinet schemes with carefully matched tonal transitions' },
