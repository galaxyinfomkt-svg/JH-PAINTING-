...
export const cityContentMap: Record<string, CityContent> = {
  ...
  'worcester': {
    ...
    solutions: [
      'Extensive multi-family experience with triple-deckers, duplexes, and apartment buildings - including coordinated tenant scheduling',
  ...
  'boston': {
    ...
    faq: [
      ...
      },
      {
        ...
        answer: 'Yes - condo painting is one of our Boston specialties. We handle all coordination with building management including providing certificates of insurance, reserving elevators, working within approved hours, and communicating with neighboring units. We understand condo buildings have specific requirements, and we make the process easy on both you and your building management.'
      },
      {
  ...
  'cambridge': {
    ...
    painPoints: [
      ...
      'Living in Cambridge - surrounded by Harvard, MIT, and the city\'s research institutions - means you hold contractors to a higher standard than most are willing to meet',
  ...
  'wellesley': {
    ...
    introText: 'Wellesley is one of the most demanding markets we work in - top-rated public schools, distinctive architecture, tree-lined streets, and homeowners who accept nothing less than careful work. JH Painting built its premium service for communities like this, where the homes are worth the extra care and the owners know the difference. From the estates near Wellesley College to the properties in Wellesley Hills and Wellesley Farms, and from Wellesley Square through to the larger residences in town, we deliver refined craftsmanship with the finest materials, meticulous prep, and the white-glove service Wellesley homeowners expect.',
    painPoints: [
...
const serviceTemplates: Record<string, {
  ...
  'residential-painting': {
    ...
    introTemplates: [
      ...
      '{cityName} homeowners deserve residential painting that simplifies their lives. Whether you need a few rooms refreshed or your entire home transformed, our {countyContext} team manages every detail. We coordinate interior and exterior work so the schedule, the prep, and the finish all line up.',
