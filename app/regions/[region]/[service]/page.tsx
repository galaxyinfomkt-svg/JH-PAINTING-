            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 500px), 1fr))', gap: '3rem', alignItems: 'center' }}>
              <div>
                <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap', marginBottom: '1.5rem' }}>
                  ...
                  <span style={{ display: 'inline-flex', alignItems: 'center', gap: '0.375rem', padding: '0.5rem 1rem', background: 'linear-gradient(135deg, #D4A853 0%, #B8923F 100%)', borderRadius: '100px', color: '#fff', fontSize: '0.875rem', fontWeight: 600 }}>
                ...
                <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
                  {[
                    ...
                    <div key={idx} style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'rgba(255,255,255,0.9)' }}>
                      <span style={{ color: '#D4A853' }}><item.icon size={16} /></span>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '3rem', flexWrap: 'wrap' }}>
              {[
                ...
                <div key={idx} style={{ textAlign: 'center' }}>
                  <div style={{ fontSize: '1.75rem', fontWeight: 800, color: '#D4A853' }}>{stat.value}</div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', padding: 'clamp(2rem, 4vw, 4rem)', background: '#0F172A' }}>
              <div>
                ...
                <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
                  ...
                  <Link href="/projects" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', color: '#D4A853', fontWeight: 600, fontSize: '0.9375rem' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', maxWidth: '900px', margin: '0 auto', padding: '0 1.5rem' }}>
              {content.process.map((step, idx) => (
                <div key={idx} style={{ background: '#fff', borderRadius: '20px', padding: '2rem 2.5rem', border: '1px solid rgba(0,0,0,0.06)', boxShadow: '0 4px 24px rgba(0,0,0,0.05)', display: 'flex', gap: '1.5rem', alignItems: 'flex-start' }}>
                  <span style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: '48px', height: '48px', minWidth: '48px', background: 'linear-gradient(135deg, #D4A853, #B8923F)', color: '#fff', borderRadius: '14px', fontSize: '1.125rem', fontWeight: 800 }}>
                    {idx + 1}
                  </span>
                  <div>
                ...
                <div className="city-about-features">
                  {[
                    ...
                    <div key={idx} className="city-about-feature">
                      <div className="city-about-feature-icon" style={{ color: '#D4A853' }}><item.icon size={24} /></div>
          ...
          <div className="container">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(min(280px, 100%), 1fr))', gap: '1rem', maxWidth: '1280px', margin: '0 auto', padding: '0 1.5rem' }}>
              {otherServices.map((svc) => (
                ...
                >
                  <span style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: '44px', height: '44px', minWidth: '44px', background: 'linear-gradient(135deg, #D4A853, #B8923F)', borderRadius: '12px' }}>
