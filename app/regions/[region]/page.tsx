...
const services = [
  ...
  { name: 'Cabinet Painting', slug: 'cabinet-painting', desc: 'Transform dated cabinets without the replacement hassle. Factory-smooth spray finish in 5-7 days.', image: 'https://storage.googleapis.com/msgsndr/0Def8kzJShLPuKrPk5Jw/media/67d854f91b97ac367f033dc3.png' },
              ...
              {region.painPoints.map((point, idx) => (
                <div key={idx} style={{ background: '#fff', borderRadius: '20px', padding: '2rem 2.5rem', border: '1px solid rgba(0,0,0,0.06)', boxShadow: '0 4px 24px rgba(0,0,0,0.05)' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem' }}>
                    ...
                    <div>
                      <p style={{ fontSize: '0.75rem', fontWeight: 700, color: '#15803D', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '0.5rem' }}>Our Solution</p>
          ...
          <div className="container">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: '0.75rem', maxWidth: '1280px', margin: '0 auto', padding: '0 1.5rem' }}>
              {regionCities.map((city) => {
                if (!city) return null
                return (
                  <Link key={city.slug} href={`/massachusetts/${normalizeCitySlug(city.slug)}`} style={{ display: 'block', background: '#fff', borderRadius: '14px', padding: '1.25rem 1.5rem', boxShadow: '0 2px 12px rgba(0,0,0,0.05)', border: '1px solid rgba(0,0,0,0.04)', textDecoration: 'none' }}>
